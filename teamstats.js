						...
						datasets: [
							{
								...
								data: [
									window.amount.get('DC'),
									window.amount.get('RCB'),
									window.amount.get('MI'),
									window.amount.get('CSK'),
									window.amount.get('RR'),
									window.amount.get('KKR'),
									window.amount.get('SRH'),
									window.amount.get('KXIP')
								],
								backgroundColor: [
									'green',
									'red',
